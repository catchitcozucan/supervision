...
public class SourcesProvider {
    ...
    @Autowired
    private SourceDetailHeaderRepository sourceDetailHeaderRepository;
    @Autowired
    ...
    public SourceDto saveSource(SourceDto sourceDto) {
        ...
        if (sourceDto.getRequestKey() != null || sourceDto.getId() != null) {
            Optional<SourcelEntity> entityPoss = sourceRepository
                    .findFirstByAccessKey(UUID.fromString(sourceDto.getRequestKey().getKey()));
